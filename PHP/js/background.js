...
domainurl = "PUT_YOUR_DOMAIN_NAME_HERE";	/*L'url du chemin de la page php que vous avez upload */
...
function manageGameNotif(gameL, jeu)
{
	if(live == 1)
	{
		...
		if(jeu && gameL != jeu && jeu != 'Talk Shows' && doIchange)
		{
...
{		
	...
	xmlhttp.onreadystatechange = function(){
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
		{
			...
			game = data.substring(21);
			var created_at = data.substring(0, 19);
